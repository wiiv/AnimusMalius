 ...
 */
package wiiv.animusmalius.common.block;

import net.minecraft.block.material.Material;
import net.minecraft.util.BlockPos;
import net.minecraft.world.IBlockAccess;
import wiiv.animusmalius.common.block.base.BlockMetaVariants;
import wiiv.animusmalius.common.block.base.BlockMetaVariants.EnumBase;
import wiiv.animusmalius.common.lib.LibBlockNames;

public class BlockMaterial extends BlockMetaVariants {
	
	public BlockMaterial() {
		super(LibBlockNames.MATERIAL, Material.iron, Variants.class);
		setHardness(5.0F);
		setResistance(10.0F);
